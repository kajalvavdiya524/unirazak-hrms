                            ...
                            @foreach ($promotions as $promotion)
                                <tr>
                                    ...
                                    @if(Gate::check('Edit Promotion') || Gate::check('Delete Promotion'))
                                        <td>
                                            @can('Edit Promotion')
                                            <a href="#" data-url="{{ route('promotion.show',$promotion->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Promotion Approved Detail')}}" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="{{__('View Detail')}}"><i class="fas fa-eye"></i></a>
