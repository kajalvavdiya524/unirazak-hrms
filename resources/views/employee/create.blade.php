                    ...
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <!-- {!! Form::text('Position', null, ['class' => 'form-control']) !!} designations -->
                                {{ Form::select('Position', $designations,null, array('class' => 'form-control  select2','required'=>'required')) }}


                            </div>
                            <div class="form-group col-md-6">
                                {!! Form::label('EmploymentType', __('Employment Type'),['class'=>'form-control-label']) !!}<span class="text-danger pl-1">*</span>
                                {{ Form::select('emp_type', $emp_type,null, array('class' => 'form-control  select2','required'=>'required')) }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <!-- {!! Form::select('empCategory', $category,null, ['class' => 'form-control']) !!} -->
                                {{ Form::select('empCategory', $category,null, array('class' => 'form-control  select2','required'=>'required')) }}

                            </div>
                            <div class="form-group col-md-6">
                            {!! Form::label('setting', __('Setting Employee'),['class'=>'form-control-label']) !!}<span class="text-danger pl-1">*</span>
                            {{ Form::select('emp_setting', $emp_addtype,null, array('class' => 'form-control  select2','required'=>'required')) }}
            ...
            <div class="card-body employee-detail-create-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {{ Form::select('positioin', $designations,null, array('class' => 'form-control  select2','required'=>'required')) }}
                ...
                <div class="card-body employee-detail-create-body">
                    <table  class="table table-striped mb-0 " id="history">
                        ...
                        <tr>
                            ...
                            <td>
                            {{ Form::select('historyadd[0][position]', $designations,null, array('class' => 'form-control  select2','required'=>'required')) }}
                ...
                <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="form-control-label">Position</label>
                             {{ Form::select('positionadd[0][position]', $designations,null, array('class' => 'form-control  select2','required'=>'required')) }}
                        ...
                        <div class="form-group col-md-6">
                             ...
                             {{ Form::select('positionadd[0][employment_type]', $emp_type,null, array('class' => 'form-control  select2','required'=>'required')) }}
