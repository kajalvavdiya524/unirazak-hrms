...
@section('content')
    ...
    @else
        <div class="row">
            ...
            @if(\Auth::user()->type=='company' && false)
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="card card-box">
                        <div class="left-card">
    ...
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left">{{__('Interview Schedule')}}</h4>
        </div>
            ...
            <div class="table-responsive">
                <table class="table align-items-center">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            <td>{{ $interviews->users->name }}</td>
                            <td>{{ \Auth::user()->dateFormat($interviews->date) }}</td>
                            <td>{{  \Auth::user()->timeFormat($interviews->time) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left">{{__(' Approve Leave Schedule')}}</h4>
        </div>
        <div class="card bg-none min-height-auto">
            <div class="table-responsive">
                <table class="table align-items-center">
                    ...
                    <tbody class="list">
                        ...
                        @if($leaves->status == 'Approve')
                        <tr>
                            <td>{{ $leaves->employees->name }}</td>

                            <td>

                                <div class="badge badge-pill badge-success">{{ $leaves->status }}

                            </td>
                            <td>{{ \Auth::user()->dateFormat($leaves->start_date) }}</td>
                            <td>{{ \Auth::user()->dateFormat($leaves->end_date) }}</td>
                            <td>{{  \Auth::user()->timeFormat($leaves->time) }}</td>
                        </tr>
                        @endif
                        @endforeach
                    </tbody>
...
<div class="row">
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left">{{__('Leave Schedule')}}</h4>
        </div>
        <div class="card bg-none min-height-auto">
            <div class="table-responsive">
                <table class="table align-items-center">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="badge badge-pill badge-danger">{{ $leaves->status }}
                                    @else
                                    <div class="badge badge-pill badge-blue">{{ $leaves->status }}
                                        @endif
                            </td>
    ...
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left">{{__('Training Schedule')}}</h4>
        </div>
        <div class="card bg-none min-height-auto">
            <div class="table-responsive">
                <table class="table align-items-center">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td>{{ \Auth::user()->dateFormat($trainings->start_date) }}</td>
                            <td>{{ \Auth::user()->dateFormat($trainings->end_date) }}</td>
                            <td>{{ \Auth::user()->timeFormat($trainings->time) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
