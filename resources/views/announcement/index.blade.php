...
@section('action-button')
    <div class="all-button-box row d-flex justify-content-end">
        @can('Create Announcement')
            ...
            <a href="#" data-url="{{ route('announcement.create') }}" class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true" data-title="{{__('Create New Announcement')}}" onclick="loadEditore()">
                        ...
                        <table class="table table-striped mb-0 dataTable" >
                            ...
                            @endphp
                                <tr>
                                    ...
                                    <a href="{{$documentPath.'/'.$announcement->documents}}" target="_blank">
                                    ...
                                    @if(Gate::check('Edit Announcement') || Gate::check('Delete Announcement'))
                                        <td>
                                            @can('Edit Announcement')
                                                <a href="#" data-url="{{ URL::to('announcement/'.$announcement->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Announcement')}}" class="edit-icon" data-toggle="tooltip" data-original-title="{{__('Edit')}}" onclick="loadEditore()"><i class="fas fa-pencil-alt"></i></a>
                                            @endcan
