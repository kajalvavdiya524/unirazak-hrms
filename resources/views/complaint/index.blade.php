                        ...
                        <tbody class="font-style">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{$documentPath.'/'.$complaint->documents}}" target="_blank">
                                ...
                                <td>
                                    @can('Edit Complaint')
                                    <a href="#" data-url="{{ URL::to('complaint/'.$complaint->id.'/edit') }}"
                                        data-size="lg" data-ajax-popup="true" data-title="{{__('Edit Complaint')}}"
                                        class="edit-icon" data-toggle="tooltip" data-original-title="{{__('Edit')}}"><i
                                    ...
                                    {!! Form::open(['method' => 'DELETE', 'route' => ['complaint.destroy',
