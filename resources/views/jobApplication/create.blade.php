<div class="card bg-none card-box">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            {{Form::label('job',__('Job'),['class'=>'form-control-label'])}}<span class="text-danger pl-1">*</span>
        ...
        <div class="form-group col-md-6 profiles d-none">
            {{Form::label('profile',__('Profile'),['class'=>'form-control-label'])}}<span class="text-danger pl-1">*</span>
        ...
        <div class="form-group col-md-6 resume d-none">
            {{Form::label('resume',__('CV / Resume'),['class'=>'form-control-label'])}}<span class="text-danger pl-1">*</span>
            <div class="choose-file form-group">
