                            ...
                            @foreach ($warnings as $warning)
                                <tr>
                                    ...
                                    @if(Gate::check('Edit Warning') || Gate::check('Delete Warning'))
                                        <td>
                                            @can('Edit Warning')
                                            <a href="#" data-url="{{ route('warning.show',$warning->id) }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Warning Detail')}}" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="{{__('View Detail')}}"><i class="fas fa-eye"></i></a>
