                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        @foreach($questions as $question)
                                ...
                                @if(in_array($question->id, $selected_question))

                                @if($question->custome_question==1)
                                ...
                                <div class="form-group col-md-12  question question_{{$question->id}}">
                                    ...
                                    <input type="text" class="form-control" name="CustomeQuestion[{{$question->question}}]" {{($question->is_required=='yes')?'required':''}}>
                                </div>
                                @elseif($question->custome_question==2)

                                @if($question->checkbox_title) 
                                @php 
                                ...
                                @endphp
                                    ...
                                    <div class="form-group col-md-12 ">
                                        {{Form::label($value[$i],__($value[$i]),['class'=>'form-control-label'])}}
                                        ...
                                        @foreach ($optiondata as $ky => $item) 
                                                ...
                                                @foreach($item as $val)
                                                    ...
                                                    <div class="custom-control custom-checkbox ml-5">
                                                        <input type="checkbox" class="custom-control-input" name="CustomeQuestion[{{$value[$i]}}][]" value="{{$val}}" id="check-{{$val}}">
                                                        <label class="custom-control-label" for="check-{{$val}}">{{$val}} </label>
                                                    </div>
                                ...
                                @elseif($question->custome_question==3)
                                        ...
                                        @foreach ($optiondata as $ky => $item) 
                                                ...
                                                @foreach($item as $val)
                                                    ...
                                                    <div class="custom-control custom-radio ml-5">
                                                        <input type="radio" class="custom-control-input" name="CustomeQuestion[{{$value[$i]}}][]" value="{{$val}}" id="check-{{$val}}">
                                                        <label class="custom-control-label" for="check-{{$val}}">{{$val}} </label>
                                                    </div>
                                ...
                                @elseif($question->custome_question==4)
                                    
                                    @if($question->dropdown_title) 
                                    @php 
                                    ...
                                    @endphp
                                        ...
                                        <div class="form-group col-md-12 ">
                                            {{Form::label($value[$i],__($value[$i]),['class'=>'form-control-label'])}}
                                            <select name="CustomeQuestion[{{$value[$i]}}][]" id="inputbox" class="form-control select2">
