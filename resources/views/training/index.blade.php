                            ...
                            @foreach ($trainings as $training)
                                <tr>
                                    ...
                                    @if( Gate::check('Edit Training') ||Gate::check('Delete Training') || Gate::check('Show Training'))
                                        <td>
                                            @can('Show Training')
                                            <a  target="_blank" href="{{route('training.create-form',\Illuminate\Support\Facades\Crypt::encrypt($training->id))}}" class="edit-icon bg-success"><i class="fas fa-file"></i></a>
