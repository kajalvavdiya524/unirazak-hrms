...
<div class="all-button-box row d-flex justify-content-end mt-2">
 ...
 <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
        <a href="#" data-url="{{ route('importView') }}" class="btn btn-xs btn-white btn-icon-only width-auto"
            data-ajax-popup="true" >
            <i class="fa fa-plus"></i> {{__('CSV')}}
        </a>
    </div>
    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
                                ...
                                <td class="Action">
                                    <span>
                                        ...
                                        <a href="#" class="edit-icon"
                                            data-url="{{ route('holiday.edit',$holiday->id) }}" data-ajax-popup="true"
                                        ...
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['holiday.destroy',
