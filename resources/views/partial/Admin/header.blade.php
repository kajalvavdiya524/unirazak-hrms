                                ...
                                <div class="list-group list-group-flush">
                                    <div class="list-group list-group-flush notification-dropdown">
                                          ...
                                          @if($users)
                                            ...
                                            <div class="list-group list-group-flush "><a href="{{ url($value->link)}}" class="list-group-item list-group-item-action">
                                                <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right" data-title="">
                                                    ...
                                                    <div class="flex-fill ml-3">
                                                        <div class="h6 text-sm mb-0">{{$value->title}} <small class="float-right text-muted">{{ \Carbon\Carbon::parse($value->created_at)->diffForHumans() }}</small></div>
                                        ...
                                        @if(Auth::user()->type == 'employee')
                                            ...
                                            <div class="list-group list-group-flush "><a href="#" class="list-group-item list-group-item-action">
                                                <div class="d-flex align-items-center" data-toggle="tooltip" data-placement="right" data-title="2 hrs ago">
                                                    ...
                                                    <div class="flex-fill ml-3">
                                                        <div class="h6 text-sm mb-0">{{$value->body}} <small class="float-right text-muted">{{ \Carbon\Carbon::parse($value->created_at)->diffForHumans() }}</small></div>
