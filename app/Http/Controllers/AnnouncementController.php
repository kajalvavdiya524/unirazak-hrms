...
class AnnouncementController extends Controller
{
    ...
    public function create()
    {
        if(\Auth::user()->can('Create Announcement'))
        {
            ...
            // $this->addJs('https://cdn.ckeditor.com/4.14.0/standard/ckeditor.js');
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Announcement'))
        {
            ...
            $announcement->description   = $request->description;
              $announcement->documents    = !empty($request->documents) ? $fileNameToStore : '';
    ...
    public function update(Request $request, Announcement $announcement)
    {
        if(\Auth::user()->can('Edit Announcement'))
        {
                  ...
                  if(!empty($request->documents))
            {
                ...
                {
                    unlink($dir . $announcement->documents);
                }
