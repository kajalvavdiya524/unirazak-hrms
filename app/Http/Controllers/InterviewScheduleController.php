...
class InterviewScheduleController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Interview Schedule'))
        {
            ...
            $schedule->employee   = implode(', ', $request->employee);
    ...
    {
        $employees = User::where('created_by', \Auth::user()->creatorId())->where('type', 'employee')->orWhere('id', \Auth::user()->creatorId())->get();
        //$employees->prepend('--', '');
    ...
    public function update(Request $request, InterviewSchedule $interviewSchedule)
    {
        if(\Auth::user()->can('Edit Interview Schedule'))
        {
            ...
            $interviewSchedule->employee  = implode(', ', $request->employee);
