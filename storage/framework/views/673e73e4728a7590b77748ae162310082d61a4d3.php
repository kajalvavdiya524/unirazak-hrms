<div class="card bg-none card-box">
    <?php echo e(Form::model($announcement,array('route' => array('announcement.update', $announcement->id), 'method' => 'PUT','enctype' => "multipart/form-data"))); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::textarea('description',null,array('class'=>'form-control summernote-simple','id'=>'eventdescription','placeholder'=>__('Enter Announcement Title')))); ?>
...
</script> <?php /**PATH /var/www/html/UniRazak/resources/views/announcement/edit.blade.php ENDPATH**/ ?>