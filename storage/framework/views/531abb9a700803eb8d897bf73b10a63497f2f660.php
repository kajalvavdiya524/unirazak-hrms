...
<?php
    $logo=asset(Storage::url('uploads/logo/'.Utility::getValByName('company_logo') ?? 'logo.png'));
?>
<?php $__env->startSection('content'); ?>
    <div class="login-contain">
        <div class="login-inner-contain">
            <a class="navbar-brand" href="#">
                <img src="<?php echo e($logo); ?>" class="navbar-brand-img auth-logo" alt="logo">
            </a>
...
unset($__errorArgs, $__bag); ?>
            ...
            <h5 class="copyright-text">
                <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright Unirazak')); ?> <?php echo e(date('Y')); ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myunicr/public_html/resources/views/auth/passwords/email.blade.php ENDPATH**/ ?>