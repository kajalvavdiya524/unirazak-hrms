    ...
    <div class="card-body">
        ...
        <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="custom-control custom-radio">
                <input type="radio" id="stage_<?php echo e($stage->id); ?>" name="stage" data-scheduleid="<?php echo e($interviewSchedule->candidate); ?>" value="<?php echo e($stage->id); ?>" class="custom-control-input stages" <?php echo e(!empty($interviewSchedule->applications)?!empty($interviewSchedule->applications->stage==$stage->id)?'checked':'':''); ?>>
                <label class="custom-control-label" for="stage_<?php echo e($stage->id); ?>"><?php echo e($stage->title); ?></label>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    <div class="card-body">
        <a href="#" data-url="<?php echo e(route('job.on.board.create', $interviewSchedule->candidate)); ?>"  data-ajax-popup="true"  class="btn btn-xs btn-white btn-icon-only width-auto" >  <?php echo e(__('Add to Job OnBoard')); ?></a>
    </div>
</div>
<?php /**PATH /home/myunicr/public_html/resources/views/interviewSchedule/show.blade.php ENDPATH**/ ?>