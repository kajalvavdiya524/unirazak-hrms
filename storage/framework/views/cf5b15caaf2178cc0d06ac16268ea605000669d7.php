                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($job->status=='pending'): ?>
                                            <span class="badge badge-soft-warning"><?php echo e(\App\JobOnBoard::$status[$job->status]); ?></span>
                                        <?php elseif($job->status=='cancel'): ?>
                                            <span class="badge badge-soft-danger"><?php echo e(\App\JobOnBoard::$status[$job->status]); ?></span>
                                        <?php else: ?>
                                            <span class="badge badge-soft-success"><?php echo e(\App\JobOnBoard::$status[$job->status]); ?></span>
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myunicr/public_html/resources/views/jobApplication/onboard.blade.php ENDPATH**/ ?>