<?php
$company_favicon=Utility::getValByName('company_favicon') ?? 'favicon.png';
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset(Storage::url('uploads/logo')).'/'.$company_favicon); ?>" type="image" sizes="16x16">
...
<?php /**PATH /home/myunicr/public_html/resources/views/layouts/auth.blade.php ENDPATH**/ ?>