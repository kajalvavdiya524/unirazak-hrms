                                ...
                                <tr>
                                    ...
                                    <?php if( Gate::check('Edit Training') ||Gate::check('Delete Training') || Gate::check('Show Training')): ?>
                                        <td>
                                            ...
                                            <a  target="_blank" href="<?php echo e(route('training.create-form',\Illuminate\Support\Facades\Crypt::encrypt($training->id))); ?>" class="edit-icon bg-success"><i class="fas fa-file"></i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/training/index.blade.php ENDPATH**/ ?>