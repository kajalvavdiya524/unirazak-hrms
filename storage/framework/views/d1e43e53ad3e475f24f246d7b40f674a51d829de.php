                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($resignation->description); ?></td>
                                       <td>
                                        ...
                                        <?php elseif($resignation->hod_resignation_approve=="1"): ?>
                                    ...
                                    <td>
                                         <?php if($resignation->hr_resignation_approve=="0"): ?>
                                        <div class="badge badge-pill badge-warning">Pending</div>
                                        <?php elseif($resignation->hr_resignation_approve=="1"): ?>
                                        <div class="badge badge-pill badge-success">Approve</div>
                                        <?php else: ?>
                                        <div class="badge badge-pill badge-danger">Reject</div>
                                        <?php endif; ?>
                                    ...
                                    <?php if(Gate::check('Edit Resignation') || Gate::check('Delete Resignation')): ?>
                                        <td>
                                              <?php if(auth()->check() && auth()->user()->hasRole('company||hr')): ?>
                                                <a href="#" data-url="<?php echo e(route('resignation.show',$resignation->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Resignation Detail')); ?>" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="<?php echo e(__('View Detail')); ?>"><i class="fas fa-eye"></i></a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/resignation/index.blade.php ENDPATH**/ ?>