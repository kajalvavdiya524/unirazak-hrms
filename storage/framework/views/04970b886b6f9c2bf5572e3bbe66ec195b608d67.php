                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong><?php echo e(__('Basic Salary')); ?></strong>
                                     <span id="demo" style="visibility:hidden;" data-salary="<?php echo e($employee->salary); ?>"></span>
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    ...
                                    <span><?php echo e($employee->title); ?></span>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('IC Number')); ?></strong>
                                    <span><?php echo e($employee->ic_number); ?></span>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="info text-sm font-style">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('EPF No.')); ?></strong>
                                    <span><?php echo e($employee->epf_number); ?></span>
                                </div>
                            </div>
                             
                            <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('Race')); ?></strong>
                                    <span><?php echo e($employee->race); ?></span>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('Office Phone')); ?></strong>
                                    <span><?php echo e($employee->office_number); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('Old IC Number')); ?></strong>
                                    <span><?php echo e($employee->old_ic_number); ?></span>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="info text-sm font-style">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('SOCSO No.')); ?></strong>
                                    <span><?php echo e($employee->socso_number); ?></span>
                                </div>
                            </div>
                             <div class="col-md-6">
                                <div class="info text-sm font-style">
                             ...
                             <div class="col-md-6">
                                <div class="info text-sm font-style">
                                    <strong><?php echo e(__('Extension')); ?></strong>
                                    <span><?php echo e($employee->extension); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/UniRazak/resources/views/employee/show.blade.php ENDPATH**/ ?>