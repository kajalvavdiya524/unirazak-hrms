                            ...
                            <?php $__currentLoopData = $travels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $travel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($travel->hod_travel_approve=="1"): ?>
                                    ...
                                    <?php if(Gate::check('Edit Travel') || Gate::check('Delete Travel')): ?>
                                        <td>
                                             <a href="#" data-url="<?php echo e(route('travel.show',$travel->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Travel Detail')); ?>" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="<?php echo e(__('View Detail')); ?>"><i class="fas fa-eye"></i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/travel/index.blade.php ENDPATH**/ ?>