                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="my-4">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="applicant[]" value="gender" id="check-gender" <?php echo e((in_array('gender',$job->applicant)?'checked':'')); ?>>
                                        <label class="custom-control-label" for="check-gender"><?php echo e(__('Gender')); ?> </label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="applicant[]" value="dob" id="check-dob" <?php echo e((in_array('dob',$job->applicant)?'checked':'')); ?>>
                                        <label class="custom-control-label" for="check-dob"><?php echo e(__('Date Of Birth')); ?></label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="applicant[]" value="country" id="check-country" <?php echo e((in_array('country',$job->applicant)?'checked':'')); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="my-4">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="visibility[]" value="profile" id="check-profile" <?php echo e((in_array('profile',$job->visibility)?'checked':'')); ?>>
                                        <label class="custom-control-label" for="check-profile"><?php echo e(__('Profile Image')); ?> </label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="visibility[]" value="resume" id="check-resume" <?php echo e((in_array('resume',$job->visibility)?'checked':'')); ?>>
                                        <label class="custom-control-label" for="check-resume"><?php echo e(__('Resume')); ?></label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="visibility[]" value="letter" id="check-letter" <?php echo e((in_array('letter',$job->visibility)?'checked':'')); ?>>
                                        <label class="custom-control-label" for="check-letter"><?php echo e(__('Cover Letter')); ?></label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="visibility[]" value="terms" id="check-terms" <?php echo e((in_array('terms',$job->visibility)?'checked':'')); ?>>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="my-4">
                                 ...
                                 <div class="custom-control custom-checkbox">
                                     <input type="checkbox" class="custom-control-input" name="custom_question[]" value="<?php echo e($question->id); ?>" id="custom_question_<?php echo e($question->id); ?>"  <?php echo e((in_array($question->id,$job->custom_question)?'checked':'')); ?>>
                                 ...
                                 ?>
                                     ...
                                     <div class="custom-control custom-checkbox">
                                         <input type="checkbox" class="custom-control-input" name="custom_question[]" value="<?php echo e($question->id); ?>" id="custom_question_<?php echo e($question->id); ?>"  <?php echo e((in_array($question->id,$job->custom_question)?'checked':'')); ?>>
                                         <label class="custom-control-label" for="custom_question_<?php echo e($question->id); ?>"><?php echo e($value[$i]); ?> </label>
                                     </div>
        ...
        <div class="col-md-6">
            <div class="card card-fluid">
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <?php echo Form::label('description', __('Job Description'),['class'=>'form-control-label']); ?>

                            <textarea class="form-control summernote-simple" name="description" id="exampleFormControlTextarea1" rows="15"><?php echo e($job->description); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/UniRazak/resources/views/job/edit.blade.php ENDPATH**/ ?>