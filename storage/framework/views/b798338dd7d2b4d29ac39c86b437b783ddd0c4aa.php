                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0 dataTable" >
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Hod Approved ')); ?></th>
                                <th><?php echo e(__('Hr Approved')); ?></th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($termination->documents)): ?>
                                        <a href="<?php echo e($documentPath.'/'.$termination->documents); ?>" target="_blank">
                                     ...
                                     <td>
                                        ...
                                        <?php elseif($termination->hod_termination_approve=="1"): ?>
                                    ...
                                    <td>
                                         <?php if($termination->hr_termination_approve=="0"): ?>
                                        <div class="badge badge-pill badge-warning">Pending</div>
                                        <?php elseif($termination->hr_termination_approve=="1"): ?>
                                        <div class="badge badge-pill badge-success">Approve</div>
                                        <?php else: ?>
                                        <div class="badge badge-pill badge-danger">Reject</div>
                                        <?php endif; ?>
                                    ...
                                    <?php if(Gate::check('Edit Termination') || Gate::check('Delete Termination')): ?>
                                        <td>
                                             <?php if(auth()->check() && auth()->user()->hasRole('company||hr')): ?>
                                             <a href="#" data-url="<?php echo e(route('termination.show',$termination->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Termination Detail')); ?>" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="<?php echo e(__('View Detail')); ?>"><i class="fas fa-eye"></i></a>
                                               <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/termination/index.blade.php ENDPATH**/ ?>