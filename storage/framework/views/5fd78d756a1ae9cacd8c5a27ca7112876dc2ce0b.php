                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0 dataTable">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Leave Remaining')); ?></th>
                                <th><?php echo e(__('Leave Reason')); ?></th>
                                <!-- <th>{ {__('status')}}</th> -->
                                <th><?php echo e(__('HOD Leave Approve')); ?></th>
                                <th><?php echo e(__('HR Leave Approve')); ?></th>
                            ...
                            <?php $__currentLoopData = $leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $totalleave =!empty(\Auth::user()->getCountLeave($leave->employee_id,$leave->leave_type_id))?\Auth::user()->getCountLeave($leave->employee_id,$leave->leave_type_id):'';
                                                $totl= 12 - $totalleave;
                                                ?>
                                                <?php echo e($totl .'/ 12 '); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/leave/index.blade.php ENDPATH**/ ?>