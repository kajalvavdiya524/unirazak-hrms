        ...
        $(document).on('change', '#jobs', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    (visibility.indexOf("profiles") != -1) ? $('.profiles').removeClass('d-none') : $('.profiles').removeClass('d-none');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/jobApplication/index.blade.php ENDPATH**/ ?>