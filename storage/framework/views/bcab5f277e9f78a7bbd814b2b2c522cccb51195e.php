...
<?php $__env->startSection('content'); ?>
    ...
    <?php else: ?>
        <div class="row">
            ...
            <?php if(\Auth::user()->type=='company' && false): ?>
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                    <div class="card card-box">
                        <div class="left-card">
    ...
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left"><?php echo e(__('Interview Schedule')); ?></h4>
        </div>
        <div class="card bg-none min-height-auto">
            <div class="table-responsive">
                <table class="table align-items-center">
                    <thead>
                        <tr>
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            <td><?php echo e($interviews->users->name); ?></td>
                            <td><?php echo e(\Auth::user()->dateFormat($interviews->date)); ?></td>
                            <td><?php echo e(\Auth::user()->timeFormat($interviews->time)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
    ...
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left"><?php echo e(__(' Approve Leave Schedule')); ?></h4>
        </div>
        <div class="card bg-none min-height-auto">
            <div class="table-responsive">
                <table class="table align-items-center">
                    ...
                    <tbody class="list">
                        ...
                        <?php if($leaves->status == 'Approve'): ?>
                        <tr>
                            <td><?php echo e($leaves->employees->name); ?></td>

                            <td>

                                <div class="badge badge-pill badge-success"><?php echo e($leaves->status); ?>


                            </td>
                            <td><?php echo e(\Auth::user()->dateFormat($leaves->start_date)); ?></td>
                            <td><?php echo e(\Auth::user()->dateFormat($leaves->end_date)); ?></td>
                            <td><?php echo e(\Auth::user()->timeFormat($leaves->time)); ?></td>
                        </tr>
                        <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
...
<div class="row">
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left"><?php echo e(__('Leave Schedule')); ?></h4>
        </div>
        <div class="card bg-none min-height-auto">
            <div class="table-responsive">
                <table class="table align-items-center">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($leaves->status == 'Reject'): ?>
                                <div class="badge badge-pill badge-danger"><?php echo e($leaves->status); ?>

                                    <?php else: ?>
                                    <div class="badge badge-pill badge-blue"><?php echo e($leaves->status); ?>
    ...
    <div class="col-md-6">
        <div class="">
            <h4 class="h4 font-weight-400 float-left"><?php echo e(__('Training Schedule')); ?></h4>
        </div>
        <div class="card bg-none min-height-auto">
            <div class="table-responsive">
                <table class="table align-items-center">
                    ...
                    <tbody class="list">
                        <?php $__currentLoopData = $training; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($trainings->types->name); ?></td>
                            <td><?php echo e(\Auth::user()->dateFormat($trainings->start_date)); ?></td>
                            <td><?php echo e(\Auth::user()->dateFormat($trainings->end_date)); ?></td>
                            <td><?php echo e(\Auth::user()->timeFormat($trainings->time)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/UniRazak/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>