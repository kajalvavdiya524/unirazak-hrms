                        ...
                        <table class="table table-striped mb-0 dataTable" >
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!empty($resignation->document)): ?>
                                            <a href="<?php echo e($documentPath.'/'.$resignation->document); ?>" target="_blank">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/UniRazak/resources/views/resignation/index.blade.php ENDPATH**/ ?>