<div class="card bg-none card-box">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            <?php echo e(Form::label('job',__('Job'),['class'=>'form-control-label'])); ?><span class="text-danger pl-1">*</span>
            <?php echo e(Form::select('job',$jobs,null,array('class'=>'form-control select2','id'=>'jobs'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('name',__('Name'),['class'=>'form-control-label'])); ?><span class="text-danger pl-1">*</span>
            <?php echo e(Form::text('name',null,array('class'=>'form-control name'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('email',__('Email'),['class'=>'form-control-label'])); ?><span class="text-danger pl-1">*</span>
            <?php echo e(Form::text('email',null,array('class'=>'form-control'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('phone',__('Phone'),['class'=>'form-control-label'])); ?><span class="text-danger pl-1">*</span>
        ...
        <div class="form-group col-md-6 profiles d-none">
            <?php echo e(Form::label('profile',__('Profile'),['class'=>'form-control-label'])); ?><span class="text-danger pl-1">*</span>
            <div class="choose-file form-group">
                ...
                <p style="color:red;font-size: 9px;">Note:Maximum file size to upload is 20.48MB (20480 KB). file Uploaded file format should be jpeg,png,jpg,gif,svg.</p>
                <p class="profile_create"></p>
            </div>
        </div>
        <div class="form-group col-md-6 resume d-none">
            <?php echo e(Form::label('resume',__('CV / Resume'),['class'=>'form-control-label'])); ?><span class="text-danger pl-1">*</span>
            <div class="choose-file form-group">
                ...
                <p style="color:red;font-size: 9px;">Note:Maximum file size to upload is 20.48MB (20480 KB). file Uploaded file format should be jpeg,png,jpg,gif,svg,pdf,doc,zip.</p>
...
<?php /**PATH C:\wamp64\www\UniRazak\resources\views/jobApplication/create.blade.php ENDPATH**/ ?>