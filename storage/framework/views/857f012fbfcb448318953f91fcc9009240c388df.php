<div class="card bg-none card-box">
    ...
    <div class="row">
        <div class="form-group col-md-6">
            <?php echo e(Form::label('candidate',__('Candidate '),['class'=>'form-control-label'])); ?>

            <?php echo e(Form::select('candidate', $candidates,null, array('class' => 'form-control select2','required'=>'required'))); ?>

        </div>
        <div class="form-group col-md-6">
            <?php echo e(Form::label('employee',__('Panel list'),['class'=>'form-control-label'])); ?>

            <?php echo e(Form::select('employee[]', $employees,null, array('class' => 'form-control select2','multiple'=>"multiple" ,'required'=>'required'))); ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\UniRazak\resources\views/interviewSchedule/create.blade.php ENDPATH**/ ?>