        ...
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                <?php if(!empty($user->avatar)): ?>
                    <div class="avatar av-m" style="background-image: url('<?php echo e(asset('/storage/'.config('chatify.user_avatar.folder').'/'.$user->avatar)); ?>');"></div>
                <?php else: ?>
                    <div class="avatar av-m" style="background-image: url('<?php echo e(asset('/storage/'.config('chatify.user_avatar.folder').'/avatar.png')); ?>');"></div>
                <?php endif; ?>
            </td>
...
<?php /**PATH /home/myunicr/public_html/resources/views/messenger/layouts/listItem.blade.php ENDPATH**/ ?>