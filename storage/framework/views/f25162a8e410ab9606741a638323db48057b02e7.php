...
<div class="all-button-box row d-flex justify-content-end mt-2">
 ...
 <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-12">
        <a href="#" data-url="<?php echo e(route('importView')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto"
            data-ajax-popup="true" >
            <i class="fa fa-plus"></i> <?php echo e(__('CSV')); ?>
        ...
        <div class="card">
            <div class="card-body py-0">
                ...
                <div class="table-responsive">
                    <table class="table table-striped mb-0 holidayDatatable">
                        <thead>
                            <tr>
                        ...
                        <tbody class="font-style">
                            ...
                            <tr>
                                 <td> <?php echo e(\Carbon\Carbon::parse($holiday->date)->format('M d Y')); ?></td> 
                                <td> <?php echo e(\Carbon\Carbon::parse($holiday->date)->format(' l ')); ?></td> 
                                ...
                                <td class="Action">
                                    <span>
                                        ...
                                        <a href="#" class="edit-icon"
                                            data-url="<?php echo e(route('holiday.edit',$holiday->id)); ?>" data-ajax-popup="true"
                                        ...
                                        <?php echo Form::open(['method' => 'DELETE', 'route' => ['holiday.destroy',
                                        $holiday->id],'id'=>'delete-form-'.$holiday->id]); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/UniRazak/resources/views/holiday/index.blade.php ENDPATH**/ ?>