    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <?php echo e(Form::select('category',$catgory,null,array('class'=>'form-control select2','required'=>'required'))); ?>
...
<?php /**PATH C:\wamp64\www\UniRazak\resources\views/companyPolicy/create.blade.php ENDPATH**/ ?>