...
<?php $__env->startSection('action-button'); ?>
    <div class="all-button-box row d-flex justify-content-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Announcement')): ?>
            ...
            <a href="#" data-url="<?php echo e(route('announcement.create')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true" data-title="<?php echo e(__('Create New Announcement')); ?>" onclick="loadEditore()">
                        ...
                        <table class="table table-striped mb-0 dataTable" >
                            ...
                            ?>
                                <tr>
                                    ...
                                    <a href="<?php echo e($documentPath.'/'.$announcement->documents); ?>" target="_blank">
                                    ...
                                    <?php if(Gate::check('Edit Announcement') || Gate::check('Delete Announcement')): ?>
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Announcement')): ?>
                                                <a href="#" data-url="<?php echo e(URL::to('announcement/'.$announcement->id.'/edit')); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Announcement')); ?>" class="edit-icon" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>" onclick="loadEditore()"><i class="fas fa-pencil-alt"></i></a>
                                            <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/UniRazak/resources/views/announcement/index.blade.php ENDPATH**/ ?>