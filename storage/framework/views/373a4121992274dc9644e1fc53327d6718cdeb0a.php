                                ...
                                <tr>
                                    <td class="Id">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Show Employee')): ?>
                                            <a href="<?php echo e(route('employee.show',\Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>"><?php echo e(\Auth::user()->employeeIdFormat($employee->employee_id,$designation)); ?></a>
                                        <?php else: ?>
                                            <a href="#"><?php echo e(\Auth::user()->employeeIdFormat($employee->employee_id, $designation)); ?></a>
                                        <?php endif; ?>
                                    </td>
                                    <td class="Id">
                                        <?php
                                        ...
                                        ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Show Employee')): ?>
                                            <a href="<?php echo e(route('employee.show',\Illuminate\Support\Facades\Crypt::encrypt($employee->id))); ?>"><?php echo e(\Auth::user()->employeeIdFormat($employee->id,$emp_type)); ?></a>
                                        <?php else: ?>
                                            <a href="#"><?php echo e(\Auth::user()->employeeIdFormat($employee->id, $emp_type)); ?></a>
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/employee/index.blade.php ENDPATH**/ ?>