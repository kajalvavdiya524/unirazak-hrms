                            ...
                            <?php $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transfer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($transfer->hod_transfer_approve=="1"): ?>
                                    ...
                                    <td>
                                         <?php if($transfer->hr_transfer_approve=="0"): ?>
                                        <div class="badge badge-pill badge-warning">Pending</div>
                                        <?php elseif($transfer->hr_transfer_approve=="1"): ?>
                                        <div class="badge badge-pill badge-success">Approve</div>
                                        <?php else: ?>
                                        <div class="badge badge-pill badge-danger">Reject</div>
                                        <?php endif; ?>
                                    ...
                                    <?php if(Gate::check('Edit Transfer') || Gate::check('Delete Transfer')): ?>
                                        <td>
                                            ...
                                            <a href="#" data-url="<?php echo e(route('transfer.show',$transfer->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Transfer Detail')); ?>" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="<?php echo e(__('View Detail')); ?>"><i class="fas fa-eye"></i></a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/transfer/index.blade.php ENDPATH**/ ?>