                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                            <?php echo e(Form::label('Training Create User',__('Create By User : '),['class'=>'form-control-label text-dark'])); ?>
                                ...
                                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($val->id==$training->created_by): ?>
                                     <?php echo e($val->name); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/training/show.blade.php ENDPATH**/ ?>