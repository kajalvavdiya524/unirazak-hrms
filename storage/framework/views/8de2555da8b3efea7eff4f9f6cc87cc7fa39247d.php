...
<div class="all-button-box row d-flex justify-content-end">
    ...
    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
        <a href="#" data-url="<?php echo e(route('complaint.create')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto"
            data-ajax-popup="true" data-title="<?php echo e(__('Create New Complaint')); ?>">
                    ...
                    <table class="table table-striped mb-0 dataTable">
                        ...
                        <tbody class="font-style">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(!empty($complaint->documents)): ?>
                                    <a href="<?php echo e($documentPath.'/'.$complaint->documents); ?>" target="_blank">
                                ...
                                <td>
                                    ...
                                    <a href="#" data-url="<?php echo e(URL::to('complaint/'.$complaint->id.'/edit')); ?>"
                                        data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Edit Complaint')); ?>"
                                        class="edit-icon" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>"><i
                                    ...
                                    <a href="#" class="delete-icon" data-toggle="tooltip"
                                        ...
                                        data-confirm-yes="document.getElementById('delete-form-<?php echo e($complaint->id); ?>').submit();"><i
                                            class="fas fa-trash"></i></a>
                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['complaint.destroy',
                                    $complaint->id],'id'=>'delete-form-'.$complaint->id]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/UniRazak/resources/views/complaint/index.blade.php ENDPATH**/ ?>