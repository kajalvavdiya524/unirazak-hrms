                                ...
                                <tr>
                                    ...
                                    <?php if(Gate::check('Edit Promotion') || Gate::check('Delete Promotion')): ?>
                                        <td>
                                            ...
                                            <a href="#" data-url="<?php echo e(route('promotion.show',$promotion->id)); ?>" data-size="lg" data-ajax-popup="true" data-title="<?php echo e(__('Promotion Approved Detail')); ?>" class="edit-icon bg-success" data-toggle="tooltip" data-original-title="<?php echo e(__('View Detail')); ?>"><i class="fas fa-eye"></i></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\UniRazak\resources\views/promotion/index.blade.php ENDPATH**/ ?>